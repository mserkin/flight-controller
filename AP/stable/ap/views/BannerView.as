...
//methods
	...
	static private function addBackToMenuButton(IsSoleButton: Boolean)
	{
		if (!tbiBackToMenu)
		{
			tbiBackToMenu = new ToolBarItem(SZ_BUTTON_SIZE.clone(), 0, 
	...
	static private function addRestartButton()
	{
		if (!tbiRestart)
		{
			tbiRestart = new ToolBarItem(SZ_BUTTON_SIZE.clone(), ToolBar.ALIGNMENT_CENTER, 
	...
	static private function addStartLevelButton()
	{
		if (!tbiStart)
		{
			tbiStart = new ToolBarItem(SZ_BUTTON_SIZE.clone(), ToolBar.ALIGNMENT_RIGHT, 
