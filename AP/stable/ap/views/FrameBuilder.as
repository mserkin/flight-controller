...
//private fields & consts
	...
	static private var FPerformanceCounterShown: Boolean = false;
...
//properties
	...
	static public function set PerformanceCounterShown(AValue: Boolean) 
	{
		FPerformanceCounterShown = AValue;
	}	
...
//methods
	...
	static private function displayDebug() 
	{
		nFrameCount++;
...
//		+ "\nFrameRect=" + FrameBuilder.FrameRect.toString()
//		+ "\nGameZoneRect=" + FrameBuilder.GameZoneRect.toString()
