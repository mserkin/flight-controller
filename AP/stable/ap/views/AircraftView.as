...
//methods
	...
	{	
		...
		//if (++nFrameCounter > Core.N_FRAME_RATE) nFrameCounter = 0;
	...
	{
//		if (AnAircraft.State==AircraftState.ReadyToTakeoff&&! AnAircraft.IsTakeoffPending
//			|| AnAircraft.Fuel < DBL_CRITICAL_FUEL_LEVEL && nFrameCounter < Core.N_FRAME_RATE / 2 && AnAircraft.State.IsComing)
//		{
//			return;
//		}
