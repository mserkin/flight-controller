...
//private fields & consts
	...
	private var FCopterRate: Number;
	private var FCurrentWind: Wind;
	private var FGates: Vector.<Gate> = new Vector.<Gate>();
	private var FLinerRate: Number;
	private var FPropRate: Number;
	private var FThumbnailMode: Boolean;
	private var FTrafficIntensity: Number;		
	//other fields
...
//properties
	...
	public function get CopterRate(): Number
    {
    	return FCopterRate;
    }
	...
	public function get LinerRate(): Number
    {
    	return FLinerRate;
    }
	
	public function get PropRate(): Number
    {
    	return FPropRate;
    }
	...
	public function get TrafficIntensity(): Number
    {
    	return FTrafficIntensity;
    }
//methods
	//constructor
	...
	private function loadAirport(AnXml: XML): void
	{
		...
		if (!FThumbnailMode)
		{
			FTrafficIntensity = AnXml.@traffic;
			FCopterRate = AnXml.@copterRate;
			FPropRate = AnXml.@propRate;
			FLinerRate = AnXml.@linerRate;				
